...
module.exports.preBuildDevelopment = async () => {
  ...
  const menusHandler = await axios.get(
    envVars.NEXT_PUBLIC_TENANT_API +
      "/api/menus/discovery-boracay-header-menu?include=nodes.children,parentNodes"
  );
  ...
  const destinationEntriesHandler = await axios.get(
    envVars.NEXT_PUBLIC_TENANT_API + `/api/contents/destinations/entries?filter[sites.id]=${envVars.NEXT_PUBLIC_MICROSITE_ID}`
  );
  ...
  const ourCollectionEntriesHandler = await axios.get(
    envVars.NEXT_PUBLIC_TENANT_API + `/api/contents/our-collection/entries?filter[sites.id]=${envVars.NEXT_PUBLIC_MICROSITE_ID}`
  );
  ...
  const blogsEntriesHandler = await axios.get(
    envVars.NEXT_PUBLIC_TENANT_API + `/api/contents/blog/entries?filter[sites.id]=${envVars.NEXT_PUBLIC_MICROSITE_ID}`
  );

  const blogsEntriesData = dataFormatter.deserialize(blogsEntriesHandler.data);

  const roomsSuitesEntriesHandler = await axios.get(
    envVars.NEXT_PUBLIC_TENANT_API + `/api/contents/roomssuites/entries?filter[sites.id]=${envVars.NEXT_PUBLIC_MICROSITE_ID}`
  );
  ...
  const experiencesEntriesHandler = await axios.get(
    envVars.NEXT_PUBLIC_TENANT_API + `/api/contents/experiences/entries?filter[sites.id]=${envVars.NEXT_PUBLIC_MICROSITE_ID}`
  );
