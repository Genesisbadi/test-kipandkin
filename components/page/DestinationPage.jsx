  ...
  return (
    <>
      <section className="page-banner relative flex items-center justify-center min-h-[560px] sm:min-h-full sm:pb-[42.2916666667%] w-full bg-[#f1f1f1]">
        ...
        {title && (
          <h2
            className={`relative sm:absolute sm:top-[50%] sm:translate-y-[-50%] font-tenor text-[35px] md:text-[42px] [text-shadow:_2px_5px_5px_rgb(0_0_0_/_100%)] px-5 text-center text-white z-[3] leading-[50px]`}
          >
            {title}
          </h2>
        )}
