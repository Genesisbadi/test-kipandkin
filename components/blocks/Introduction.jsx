          ...
          {title ? (
            <div className="flex flex-col items-center w-full">
              <div className="flex w-full border-b border-[#c5baa6] justify-center ">
                <span className="text-[#c5baa6] text-[20px] pb-[35px]">
                  {title}
                </span>
              </div>
              <div
                dangerouslySetInnerHTML={{ __html: description }}
                className="text-white text-[14px] leading-[25px] text-center max-w-[957px] pt-[35px]"
              />
            </div>
          ) : (
            <div
              dangerouslySetInnerHTML={{ __html: description }}
              className="text-white text-[14px] leading-[25px] text-center max-w-[957px]"
            />
          )}
        </div>
      </section>
